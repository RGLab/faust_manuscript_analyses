...
gaussianSwitch <- TRUE #if true, multivariate gaussian samples simulated.
sampleSize <- 25000
...
# [weight of component 111]/[weight of component 120] = 1.9
# ...
# [weight of component 115]/[weight of component 120] = 1.5
# In this simulation, the 120th component has its mass spiked to 
# components [110,111,...,115] in 10 of the samples. These spiked
...
#(settings are set explicity to their default in an attempt to preserve results across R versions)
#
############################################################################################################
